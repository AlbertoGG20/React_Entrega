    ...
    <footer>
      <div className="footer-wrapper">
        ...
        <div className="footer-credits">
          <p>© 2024 RUTA DEL AGUA Todos los derechos reservados <a href="">Política de Privacidad</a> y <a href="/cookies">Cookies</a> </p>
        </div>

      </div>
      {typeof cookies.cookieConsent === 'undefined' && <Cookies />}
    </footer>
  )
}
