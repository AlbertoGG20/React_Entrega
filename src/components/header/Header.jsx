  ...
  return (
    <header className={head ? 'header-wrapper show-back' : 'header-wrapper'}>
      <div className="header-content-wrapper">
        ...
        <svg onClick={activ} className={head ? 'header-menu-buttom color-hamburguer' : 'header-menu-buttom'} viewBox="0 0 32 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <nav className={active ? 'nav-wrapper active' : 'nav-wrapper'}>
          <svg onClick={desactiv} className="nav-close" viewBox="0 0 59 59" fill="none" xmlns="http://www.w3.org/2000/svg">
