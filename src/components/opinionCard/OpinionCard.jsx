        ...
        <>
            <div className="opinion-card-wrapper">
                <div className="opinion-card-head">
                    <div className="opinion-user-img"></div>
